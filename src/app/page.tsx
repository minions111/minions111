...
export default function Home() {
  ...
  const currentTerminalState = terminals[activeTerminal] || { view: 'MARKET', ticker: 'AAPL' };
  const view = currentTerminalState.view;
  const selectedTicker = currentTerminalState.ticker;
