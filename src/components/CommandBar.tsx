  ...
  return (
    <div className="bg-[#222] border-b border-[#333] p-1 flex items-center gap-2 relative z-[1000]">
      ...
      <div className="flex-1 relative">
        <form onSubmit={handleSubmit} className="flex items-center bg-black border border-[#444] px-2 py-0.5" role="search">
          <Search className="w-3 h-3 text-[#ffb900] mr-2" />
          <input
            type="text" value={command} onKeyDown={handleKeyDown}
            ...
            aria-haspopup="listbox" aria-controls="command-suggestions"
          ...
          <div id="command-suggestions" role="listbox" className="absolute top-full left-0 right-0 bg-black border border-[#444] shadow-2xl mt-1">
            {suggestions.map((s, i) => (
              <div
                ...
                onMouseEnter={() => setSelectedIndex(i)} onClick={() => handleSelectSuggestion(s)}
                className={`p-2 font-mono text-xs cursor-pointer border-b border-[#111] ${
