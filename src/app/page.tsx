...
export default function Home() {
  ...
  const activeTerminalState = terminals[activeTerminal] || { view: 'MARKET', ticker: 'AAPL' };
  const view = activeTerminalState.view;
  const selectedTicker = activeTerminalState.ticker;
  ...
  }, [activeTerminal, view, handleCommand, isLoaded]);
