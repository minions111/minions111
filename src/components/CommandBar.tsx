  ...
  return (
    <div className="bg-[#222] border-b border-[#333] p-1 flex items-center gap-2 relative z-[1000]">
      ...
      <div className="flex-1 relative" role="combobox" aria-expanded={showSuggestions} aria-haspopup="listbox" aria-controls="command-suggestions">
        <form onSubmit={(e) => { e.preventDefault(); if (command.trim()) handleSelectSuggestion(command.trim().toUpperCase()); }} className="flex items-center bg-black border border-[#444] px-2 py-0.5">
