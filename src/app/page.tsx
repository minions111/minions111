...
export default function Home() {
  ...
  }, [view, activeTerminal, setView, setSelectedTicker]);
  ...
  }, [activeTerminal, view, handleCommand]); // Added handleCommand to deps but it's stable if defined as arrow function or moved up
